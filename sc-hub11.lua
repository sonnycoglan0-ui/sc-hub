...
-- GRADIENT BACKGROUND (YOUR COLOR)
local gradient = Instance.new("UIGradient", main)
gradient.Color = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 100, 50)),   -- Green
	ColorSequenceKeypoint.new(1, Color3.fromRGB(120, 0, 120))  -- Purple
})
...
local function fixCharacter()
	-- REMOVE GREY BLOCK / SHIRT GRAPHIC
...
local function getCharacter()
	...
	fixCharacter() -- FIX THE GREY BLOCK HERE
end
getCharacter()
...
RunService.RenderStepped:Connect(function()
	...
	if flying and bodyVel and bodyGyro then
		...
		local movement = (forward * moveDir.Z + right * moveDir.X) * speed
		local vertical = Vector3.new(0, (upHeld and speed or 0) - (downHeld and speed or 0), 0)
		
		local target = movement + vertical
