...
-- GRADIENT BACKGROUND (YOUR EXACT COLORS)
local gradient = Instance.new("UIGradient", main)
gradient.Color = ColorSequence.new{
	ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 120, 60)),   -- green
	ColorSequenceKeypoint.new(0.5, Color3.fromRGB(40, 60, 120)), -- blue
...
-- FIX: Only drag slider if clicking knob, and stop menu drag
knob.InputBegan:Connect(function(i)
	if i.UserInputType == Enum.UserInputType.MouseButton1 or i.UserInputType == Enum.UserInputType.Touch then
		draggingSlider = true
		dragging = false -- Prevent menu from moving
	end
end)
...
RunService.RenderStepped:Connect(function()
	...
	-- FLY LOGIC (SWIM TECHNIQUE)
	if flying and bodyGyro then
		local camCF = workspace.CurrentCamera.CFrame
		
		-- Keep rotation correct
